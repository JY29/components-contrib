module github.com/JY29/components-contrib/tests/certification/bindings/localstorage

go 1.19

require (
	github.com/JY29/components-contrib v1.9.6
	github.com/JY29/components-contrib/tests/certification v0.0.0-00010101000000-000000000000
